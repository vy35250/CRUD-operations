...
node_certificate = '/home/cs6238/Desktop/Project4/client2/certs/client2.crt'
node_key = '/home/cs6238/Desktop/Project4/client2/certs/client2.key'
...
def login():
    ...
    while not successful_login:
        ...
        # Ex: '/home/cs6238/Desktop/Project4/client2/userkeys/' + private_key_filename
        user_private_key_file = '/home/cs6238/Desktop/Project4/client2/userkeys/' + private_key_filename

        # create the statement
        statement = 'client2 as ' + user_id + ' logs into the server'
        #print(statement)
...
def checkin(session_token):
    ...
    file_path = '/home/cs6238/Desktop/Project4/client2/documents/checkin/' + did  # Adjust the path according to your setup
...
def checkout(session_token):
    ...
    """
    did = input("Enter DID (document ID/filename): ")
    # file_path = '/home/cs6238/Desktop/Project4/client2/documents/checkout/' + did
    # with open(file_path, 'r') as f:
    #     file_data = f.read()
    body = {
        'DID': did,
